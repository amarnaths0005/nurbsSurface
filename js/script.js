...
function init() {
    ...
    selUdegree.addEventListener('change', function () {
    ...
    selWdegree.addEventListener('change', function () {
    ...
    document.getElementById('knotU').addEventListener('click', function () {
    ...
    document.getElementById('knotW').addEventListener('click', function () {
...
function initializeValues() {
    ...
    points[0][3].x = -0.1; points[0][3].y = -1.00; points[0][3].z = -0.0;
    points[0][4].x = 0.1; points[0][4].y = -1.00; points[0][4].z = 0.33;
    points[0][5].x = -0.1; points[0][5].y = -1.00; points[0][5].z = 0.66;
    points[0][6].x = 0.1; points[0][6].y = -1.00; points[0][6].z = 1.0;

    points[1][0].x = -0.1; points[1][0].y = -0.66; points[1][0].z = -1.0;
    points[1][1].x = 0.1; points[1][1].y = -0.66; points[1][1].z = -0.66;
    points[1][2].x = -0.1; points[1][2].y = -0.66; points[1][2].z = -0.33;
    points[1][3].x = 0.1; points[1][3].y = -0.66; points[1][3].z = -0.0;
    points[1][4].x = -0.1; points[1][4].y = -0.66; points[1][4].z = 0.33;
    points[1][5].x = 0.1; points[1][5].y = -0.66; points[1][5].z = 0.66;
    points[1][6].x = -0.1; points[1][6].y = -0.66; points[1][6].z = 1.0;

    points[2][0].x = 0.1; points[2][0].y = -0.33; points[2][0].z = -1.0;
    points[2][1].x = -0.1; points[2][1].y = -0.33; points[2][1].z = -0.66;
    points[2][2].x = 0.1; points[2][2].y = -0.33; points[2][2].z = -0.33;
    points[2][3].x = -0.1; points[2][3].y = -0.33; points[2][3].z = -0.0;
    points[2][4].x = 0.1; points[2][4].y = -0.33; points[2][4].z = 0.33;
    points[2][5].x = -0.1; points[2][5].y = -0.33; points[2][5].z = 0.66;
    points[2][6].x = 0.1; points[2][6].y = -0.33; points[2][6].z = 1.0;

    points[3][0].x = -0.1; points[3][0].y = 0.0; points[3][0].z = -1.0;
    points[3][1].x = 0.1; points[3][1].y = 0.0; points[3][1].z = -0.66;
    points[3][2].x = -0.1; points[3][2].y = 0.0; points[3][2].z = -0.33;
    points[3][3].x = 0.1; points[3][3].y = 0.0; points[3][3].z = -0.0;
    points[3][4].x = -0.1; points[3][4].y = 0.0; points[3][4].z = 0.33;
    points[3][5].x = 0.1; points[3][5].y = 0.0; points[3][5].z = 0.66;
    points[3][6].x = -0.1; points[3][6].y = 0.0; points[3][6].z = 1.0;

    points[4][0].x = 0.1; points[4][0].y = 0.33; points[4][0].z = -1.0;
    points[4][1].x = -0.1; points[4][1].y = 0.33; points[4][1].z = -0.66;
    points[4][2].x = 0.1; points[4][2].y = 0.33; points[4][2].z = -0.33;
    points[4][3].x = -0.1; points[4][3].y = 0.33; points[4][3].z = -0.0;
    points[4][4].x = 0.1; points[4][4].y = 0.33; points[4][4].z = 0.33;
    points[4][5].x = -0.1; points[4][5].y = 0.33; points[4][5].z = 0.66;
    points[4][6].x = 0.1; points[4][6].y = 0.33; points[4][6].z = 1.0;

    points[5][0].x = -0.1; points[5][0].y = 0.66; points[5][0].z = -1.0;
    points[5][1].x = 0.1; points[5][1].y = 0.66; points[5][1].z = -0.66;
    points[5][2].x = -0.1; points[5][2].y = 0.66; points[5][2].z = -0.33;
    points[5][3].x = 0.1; points[5][3].y = 0.66; points[5][3].z = -0.0;
    points[5][4].x = -0.1; points[5][4].y = 0.66; points[5][4].z = 0.33;
    points[5][5].x = 0.1; points[5][5].y = 0.66; points[5][5].z = 0.66;
    points[5][6].x = -0.1; points[5][6].y = 0.66; points[5][6].z = 1.0;

    points[6][0].x = 0.1; points[6][0].y = 1.00; points[6][0].z = -1.0;
    points[6][1].x = -0.1; points[6][1].y = 1.00; points[6][1].z = -0.66;
    points[6][2].x = 0.1; points[6][2].y = 1.00; points[6][2].z = -0.33;
    points[6][3].x = -0.1; points[6][3].y = 1.00; points[6][3].z = -0.0;
    points[6][4].x = 0.1; points[6][4].y = 1.00; points[6][4].z = 0.33;
    points[6][5].x = -0.1; points[6][5].y = 1.00; points[6][5].z = 0.66;
    points[6][6].x = 0.1; points[6][6].y = 1.00; points[6][6].z = 1.0;
...
function updatePointsTable() {
    ...
    for (let j = 0; j < noPoints; ++j) {
        for (let i = 0; i < noPoints; ++i) {
            ...
            tableData += '<td><button onclick="editRow(' + i + ',' + j + ')">Edit</button></td>';
            tableData += '</tr>';
        }
    }
...
function computeNurbsSurface() {
    nurbsSurface = new NURBSSurface(
        degreeU, degreeW, knotVectorU, knotVectorW, points);
